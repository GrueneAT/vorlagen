...
class FlyerA6PortraitLayoutTest(unittest.TestCase):
    ...
    def test_vollkorn_split_line_uses_rendered_ink_correction(self):
        ...
        # line1 Gotham -> line2 Vollkorn -> line3 Gotham.
        ...
        # Page-2 headline u1214: 30pt, IDML leading 27.0pt. line1 Gotham -> line2 Vollkorn.
        p1 = float(self.pos["u1214"].get("YPOS"))
        p2 = float(self.pos["u1214_l2"].get("YPOS"))
        exp_p2 = (
            p1 + 27.0
            - font_ascent_pt(VOLLKORN, 30.0)
            + font_ascent_pt(GOTHAM, 30.0)
        )
